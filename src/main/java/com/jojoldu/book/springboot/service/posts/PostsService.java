...
public class PostsService {
    ...
    public PostsResponseDto findById (Long id) {
        Posts entity = postsRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("헤당 게시물이 없습니다. id = " + id));

        return new PostsResponseDto(entity);
    }

    // readOnly를 주면 트랜잭션 범위는 유지하되, 조회 기능만 남겨두어 조회 속도가 개선된다.
